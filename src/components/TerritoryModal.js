...
export default function TerritoryModal({ modalData, closeModal, attackEnable, attackRequest }) {
    return (
            ...
            <div className="flex flex-col fixed p-4 w-[580px] border-2 border-[#808080]
             bg-black rounded-[32px] ">
                ...
                <div className="h-full justify-center items-center">
                    ...
                    {attackEnable && <div className='mt-4'>
                        <p className='w-full rounded-full bg-[#ff004b] p-3 border-4 border-[#808080] text-center text-[20px] font-bold cursor-pointer' onClick={attackRequest}>Attack!</p>
                    </div>}
